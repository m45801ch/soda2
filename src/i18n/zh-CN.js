...
export default {
  ...
  settings: {
    ...
    aiUsageToday: '今日 AI 优化成功次数',
    aiUsageTimes: ' 次',
    backup: {
      title: '备份与还原',
      desc: '备份所有自定义数据（主 prompt、修饰模式、专业词库、热词、字典、设置）为单一 JSON 文件。',
      cloudTarget: '云空间',
      noCloud: '尚未选择',
      customFolder: '自选文件夹…',
      notInstalled: '未安装',
      rescan: '重新检测',
      rescanAfterInstall: '我已安装完成，重新检测',
      guideTitle: '{name} 设置引导',
      download: '下载安装',
      cloudReady: '已就绪：{path}',
      needCloud: '请先选择云空间或文件夹',
      actions: '备份',
      backupNow: '立即备份到云端',
      saveLocal: '另存到本地文件夹',
      backupDone: '备份完成',
      backupFailed: '备份失败',
      autoBackup: '自动备份',
      autoBackupDesc: '每天自动备份一次到选定的云文件夹',
      lastAuto: '上次自动备份：',
      restore: '还原备份',
      restoreScopeAll: '全部（设置 + 主 prompt + 模式 + 词库 + 热词 + 字典）',
      restoreScopeSettings: '只还原一般设置',
      restoreScopeStyle: '只还原主 prompt / 修饰模式 / 专业词库',
      restoreScopeWords: '只还原热词 + 字典',
      restoreNow: '选择备份文件并还原',
      restoreDone: '还原完成，建议重新加载设置',
      restoreFailed: '还原失败',
      cloudSet: '已设置云文件夹',
    },
    backupCloud: {
      installNote: {
        ...
        nextcloud: '需要安装「Nextcloud 桌面版」并连接到你的 Nextcloud 服务器，即会创建同步文件夹。',
      },
      step: {
        'onedrive.1': '下载并打开 OneDrive（Windows 内置，或从微软官网下载）。',
        ...
        'box.1': '从 Box 官网下载并安装 Box Drive。',
        'box.2': '登录你的 Box 账户。',
        'box.3': '确认 C:\\Users\\你\\Box 文件夹已出现。',
        'icloud.1': '从 Microsoft Store 安装「iCloud for Windows」。',
        'icloud.2': '打开 iCloud，登录 Apple 账户并启用 iCloud Drive。',
        'icloud.3': '确认 C:\\Users\\你\\iCloud Drive 文件夹已出现。',
        'nextcloud.1': '从 Nextcloud 官网下载并安装 Nextcloud 桌面版。',
        'nextcloud.2': '输入你的 Nextcloud 服务器地址并登录。',
        'nextcloud.3': '确认 C:\\Users\\你\\Nextcloud 文件夹已出现。',
      },
    },
    fetchModels: '整理模型列表',
