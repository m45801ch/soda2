...
export default {
  ...
  settings: {
    ...
    convertOrdinalNumbers: '中文序數轉數字',
    convertOrdinalNumbersDesc: '講「一點一、一點二」或「一、二、三」時自動轉成 1.1、1.2 或 1. 2. 3. 格式。預設關閉。',
    ...
    backup: {
      ...
      notInstalled: '未安裝',
      rescan: '重新偵測',
      rescanAfterInstall: '我已完成安裝，重新偵測',
      guideTitle: '{name} 設定引導',
      download: '下載安裝',
      cloudReady: '已就緒：{path}',
      needCloud: '請先選擇雲端空間或資料夾',
      actions: '備份',
      backupNow: '立即備份到雲端',
      saveLocal: '另存到本機資料夾',
      backupDone: '備份完成',
      backupFailed: '備份失敗',
      autoBackup: '自動備份',
      autoBackupDesc: '每天自動備份一次到選定的雲端資料夾',
      lastAuto: '上次自動備份：',
      restore: '還原備份',
      restoreScopeAll: '全部（設定 + 主 prompt + 模式 + 詞庫 + 熱詞 + 字典）',
      restoreScopeSettings: '只還原一般設定',
      restoreScopeStyle: '只還原主 prompt / 修飾模式 / 專業詞庫',
      restoreScopeWords: '只還原熱詞 + 字典',
      restoreNow: '選擇備份檔並還原',
      restoreDone: '還原完成，建議重新載入設定',
      restoreFailed: '還原失敗',
      cloudSet: '已設定雲端資料夾',
    },
    backupCloud: {
      installNote: {
        onedrive: 'OneDrive 通常內建於 Windows。登入 Microsoft 帳戶後即會建立 OneDrive 資料夾。',
        gdrive: '需要安裝「Google Drive for desktop」並登入 Google 帳戶。串流模式會掛載成磁碟槽（如 G:），鏡像模式則建立「Google Drive / My Drive」同步資料夾。',
        dropbox: '需要安裝「Dropbox 桌面版」並登入，即會建立 Dropbox 同步資料夾。',
        box: '需要安裝「Box Drive」並登入 Box 帳戶，即會建立 Box 同步資料夾。',
        icloud: '需要安裝「iCloud for Windows」（Microsoft Store 下載）並登入 Apple 帳戶，開啟 iCloud Drive 後即會建立同步資料夾。',
        nextcloud: '需要安裝「Nextcloud 桌面版」並連線到你的 Nextcloud 伺服器，即會建立同步資料夾。',
      },
      step: {
        'onedrive.1': '下載並開啟 OneDrive（Windows 內建，或從 Microsoft 官網下載）。',
        'onedrive.2': '登入你的 Microsoft 帳戶。',
        'onedrive.3': '確認 C:\\Users\\你\\OneDrive 資料夾已出現。',
        'gdrive.1': '從 Google 官網下載「Google Drive for desktop」並安裝。',
        'gdrive.2': '登入你的 Google 帳戶，選擇「串流」（Stream）或「鏡像」（Mirror）模式。',
        'gdrive.3': '串流模式：確認「我的電腦」出現 Google Drive 磁碟槽（如 G:）；鏡像模式：確認 C:\\Users\\你\\Google Drive 資料夾已出現。',
        'dropbox.1': '從 Dropbox 官網下載並安裝 Dropbox 桌面版。',
        'dropbox.2': '登入你的 Dropbox 帳戶。',
        'dropbox.3': '確認 C:\\Users\\你\\Dropbox 資料夾已出現。',
        'box.1': '從 Box 官網下載並安裝 Box Drive。',
        'box.2': '登入你的 Box 帳戶。',
        'box.3': '確認 C:\\Users\\你\\Box 資料夾已出現。',
        'icloud.1': '從 Microsoft Store 安裝「iCloud for Windows」。',
        'icloud.2': '開啟 iCloud，登入 Apple 帳戶並啟用 iCloud Drive。',
        'icloud.3': '確認 C:\\Users\\你\\iCloud Drive 資料夾已出現。',
        'nextcloud.1': '從 Nextcloud 官網下載並安裝 Nextcloud 桌面版。',
        'nextcloud.2': '輸入你的 Nextcloud 伺服器網址並登入。',
        'nextcloud.3': '確認 C:\\Users\\你\\Nextcloud 資料夾已出現。',
      },
    },
    fetchModels: '整理模型清單',
    ...
    hotkeysTab: {
      ...
      aiOptimizeTrigger: {
        ...
        custom: '自訂...',
        pressKeys: '請按新的快捷鍵...',
        recordingHint: '按下要使用的按鍵或組合鍵（例如 Ctrl+Alt+T）',
